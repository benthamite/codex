...
Completed assistant messages in =app-server= buffers receive lightweight Markdown highlighting for headings, bold spans, inline code, and fenced code blocks.
